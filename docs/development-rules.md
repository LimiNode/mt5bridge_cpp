...
- Keep public SDK headers under `include/mt5bridge/` and private implementation
  under the owning `src/{bridge,runtime,market,trade,dispatch}/` directory.
  Private headers belong beside their implementation files; do not create a
  parallel private include tree.
